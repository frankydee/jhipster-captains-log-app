...
import { CaptainsLogComponent } from 'app/entities/captains-log/captains-log.component';
...
describe('Component Tests', () => {
    describe('CaptainsLog Management Component', () => {
        let comp: CaptainsLogComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CaptainsLogComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.captainsLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
