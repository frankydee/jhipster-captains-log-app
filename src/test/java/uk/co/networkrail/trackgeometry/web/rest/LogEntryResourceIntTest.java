...
public class LogEntryResourceIntTest {
    ...
    private static final InvalidationCode DEFAULT_INVALIDATION_CODE = InvalidationCode.OFF_ROUTE;
    private static final InvalidationCode UPDATED_INVALIDATION_CODE = InvalidationCode.INSTRUMENT_FAILURE;
    ...
    public static LogEntry createEntity(EntityManager em) {
        LogEntry logEntry = new LogEntry()
            ...
            .invalidationCode(DEFAULT_INVALIDATION_CODE);
        return logEntry;
    }
    ...
    public void createLogEntry() throws Exception {
        ...
        assertThat(testLogEntry.getStartMileage()).isEqualTo(DEFAULT_START_MILEAGE);
        assertThat(testLogEntry.getEndMileage()).isEqualTo(DEFAULT_END_MILEAGE);
        assertThat(testLogEntry.getInvalidationCode()).isEqualTo(DEFAULT_INVALIDATION_CODE);
    }
    ...
    public void getAllLogEntries() throws Exception {
        ...
        restLogEntryMockMvc.perform(get("/api/log-entries?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].invalidationCode").value(hasItem(DEFAULT_INVALIDATION_CODE.toString())));
    }
    ...
    public void getLogEntry() throws Exception {
        ...
        restLogEntryMockMvc.perform(get("/api/log-entries/{id}", logEntry.getId()))
            ...
            .andExpect(jsonPath("$.invalidationCode").value(DEFAULT_INVALIDATION_CODE.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateLogEntry() throws Exception {
        ...
        updatedLogEntry
            ...
            .invalidationCode(UPDATED_INVALIDATION_CODE);
        ...
        LogEntry testLogEntry = logEntryList.get(logEntryList.size() - 1);
        assertThat(testLogEntry.getStartMileage()).isEqualTo(UPDATED_START_MILEAGE);
        assertThat(testLogEntry.getEndMileage()).isEqualTo(UPDATED_END_MILEAGE);
        assertThat(testLogEntry.getInvalidationCode()).isEqualTo(UPDATED_INVALIDATION_CODE);
    }
