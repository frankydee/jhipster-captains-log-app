package uk.co.networkrail.trackgeometry.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(uk.co.networkrail.trackgeometry.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(uk.co.networkrail.trackgeometry.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
